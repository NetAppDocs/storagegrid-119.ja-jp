...
summary: サンプル ファイルを使用すると、4 つの Linux 物理インターフェイスを単一の LACP ボンドに集約し、ボンドに従属する 3 つの VLAN インターフェイスを確立して、 StorageGRIDグリッド、管理、およびクライアント ネットワーク インターフェイスとして使用できます。 
---
...
[role="lead"]
サンプル ファイルを使用すると、4 つの Linux 物理インターフェイスを単一の LACP ボンドに集約し、ボンドに従属する 3 つの VLAN インターフェイスを確立して、 StorageGRIDグリッド、管理、およびクライアント ネットワーク インターフェイスとして使用できます。
